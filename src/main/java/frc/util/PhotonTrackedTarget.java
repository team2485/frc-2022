...
public class PhotonTrackedTarget {
  ...
  public static final int PACK_SIZE_BYTES = Double.BYTES * (5 + 7 + 2 * 4 + 1 + 7 + 2 * MAX_CORNERS);
   ...
   *
   * <p>
   * For fiducials, the order is known and is always counter-clock wise around the
   * tag, like so
   *
   * <p>
   * spotless:off
