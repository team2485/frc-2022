...
public final class Constants {
	...
	public static final double kDriveSlewRate =
	    3; // units per second to limit rate to, inverse of how long it will
	       // take from 0 to 1
	...
	public static final double
	    kAutoMaxAngularAccelerationRadiansPerSecondSquared = 3 * Math.PI;
	...
	public static final TrapezoidProfile
	    .Constraints kAutoThetaControllerConstraints =
	...
	public static final double kDriveGearRatio =
	    8.16; // motor turns per wheel turns
	...
	public static final double kDriveDistMetersPerPulse =
	    kDriveDistMetersPerMotorRev / kFalconCPR;
	////NOTE: CTRE Encoders return velocity in units/100 ms. CTRE velocity
	/// readings should be multiplied by 10 to be per second.
	...
	public static final double kTurningGearRatio =
	    12.8; // motor turns per shaft turns
	public static final double kTurningRadiansPerMotorRev =
	    2 * Math.PI / kTurningGearRatio;
	public static final double kTurningRadiansPerPulse =
	    kTurningRadiansPerMotorRev / kFalconCPR;

	public static final double blah =
	    Math.PI / 4 * 1 / kTurningRadiansPerPulse;
	...
	public static final double kaTurningVoltSecondsSquaredPerMeter =
	    0.0068542;
	...
	public static final double kModuleMaxSpeedTurningRadiansPerSecond =
	    16 * Math.PI;
	public static final double
	    kModuleMaxAccelerationTurningRadiansPerSecondSquared =
		256 * Math.PI;
	public static final double kModuleMaxSpeedTurningPulsesPer100Ms =
	    kModuleMaxSpeedTurningRadiansPerSecond / kTurningRadiansPerPulse *
	    0.1;
	public static final double
	    kModuleMaxAccelerationTurningPulsesPer100MsSquared =
		kModuleMaxAccelerationTurningRadiansPerSecondSquared /
		kTurningRadiansPerPulse * 0.01;
    }
	...
	public static final double kTeleopMaxSpeedMetersPerSecond =
	    2; // meters per second
	...
	public static final SwerveDriveKinematics kDriveKinematics =
		...
		new Translation2d(kWheelbaseLengthMeters / 2,
    ...
    public static final class Hood { // check constants for possible updates
	public static final int SPARK_PORT = 0;

	public static final int DISTANCE_PER_REVOLUTION = 360;
	...
	public static final String HOOD_VELOCITY_CONTROLLER_CONFIGURABLE_LABEL =
	    "hoodVelocityController";
	public static final String HOOD_POSITION_CONTROLLER_CONFIGURABLE_LABEL =
	    "hoodPositionController";
