...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double kvDriveVoltSecondsPerMeter =
        IDManager.getInstance().select(2.2729, 2.2729);
    public static final double kaDriveVoltSecondsSquaredPerMeter =
        IDManager.getInstance().select(0.37446, 0.37446);
  ...
  public static final class IntakeConstants {
    ...
    public static final double kVIntakeVoltSecondsPerMeter = IDManager.getInstance().select(0.08, 0.1);
    public static final double kAIntakeVoltSecondsSquaredPerMeter = IDManager.getInstance().select(0.01, 0.01);
  ...
  public static final class IntakeArmConstants {
    ...
    public static final double kIntakeArmTopPositionRadians = IDManager.getInstance().select(1.988, 2.0071); // change later

    public static final double kIntakeArmEncoderOffset = IDManager.getInstance().select(3.28 + 0.038 -0.2618, 5.44 - 0.2618);
  ...
  public static final class IndexerConstants {
    ...
    public static final double kAIndexerVoltSecondsSquaredPerMeter = IDManager.getInstance().select(0.005,0.005);
  ...
  public static final class FeederConstants {
    ...
    public static final double kVFeederVoltSecondsPerMeter = IDManager.getInstance().select(0.24889,0.11065);
    public static final double kAFeederVoltSecondsSquaredPerMeter = IDManager.getInstance().select(0.033443,0.023167);
  ...
  public static final class HoodConstants {
    ...
    public static final double kvHoodVoltSecondsPerRadian = IDManager.getInstance().select(1.1003,0.99111);
    public static final double kaHoodVoltSecondsSquaredPerRadian = IDManager.getInstance().select(0.1298,0.12369);
  ...
  public static final class ShooterConstants {
    ...
    public static final double kShooterFreeSpeedRotationsPerSecond = IDManager.getInstance().select(kFalconFreeSpeedRotationsPerSecond/kShooterGearRatio, 93.2);
    ...
    public static final double kVShooterVoltSecondsPerMeter = IDManager.getInstance().select(0.071665, 0.10773);
    public static final double kAShooterVoltSecondsSquaredPerMeter = IDManager.getInstance().select(0.0057801, 0.0091575);

    public static final double kShooterFeedforwardScale = IDManager.getInstance().select(0.91, 0.95);
  ...
  public static final class ClimbArmConstants {
    ...
    public static final double ksArmTranslationVolts = IDManager.getInstance().select(0.57233,0.55953);
    public static final double kgArmTranslationVolts =IDManager.getInstance().select(0.023933,0.18092);
    public static final double kvArmTranslationVoltSecondsPerMeter = IDManager.getInstance().select(103.19,62.802);
    public static final double kaArmTranslationVoltSecondsSquaredPerMeter = IDManager.getInstance().select(8.7859,0.04);
