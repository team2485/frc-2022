...
public class AutoCommandBuilder {
  ...
  public static Command get5BallAuto(
        ...
        WL_SwerveControllerCommand part2 =
            getPathCommand(drivetrain, "5 Ball Pt. 2");
        
        WL_SwerveControllerCommand part3 =
            getPathCommand(drivetrain, "5 Ball Pt. 3");
                ...
                new InstantCommand(
                    () ->
                        drivetrain
                            .getField2d()
                            .getObject("traj")
                            .setTrajectory(part2.m_trajectory),
                    drivetrain),
