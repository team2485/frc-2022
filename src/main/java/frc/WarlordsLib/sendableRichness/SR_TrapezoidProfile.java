 ...
 */
public class SR_TrapezoidProfile {
   ...
   */
  public SR_TrapezoidProfile(Constraints constraints, State goal, State initial) {
   ...
   * @param goal The desired state when the profile is complete.
   */
  public SR_TrapezoidProfile(Constraints constraints, State goal) {
