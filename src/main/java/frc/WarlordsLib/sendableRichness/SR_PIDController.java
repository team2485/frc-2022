...
public class SR_PIDController implements Sendable, AutoCloseable {
   ...
   */
  public SR_PIDController(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
   ...
   */
  public SR_PIDController(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
